...
function deleteEntry (e) {   
  Axios.delete(`http://localhost:5000/stock/delete/${e}`)
    .then(res => {
      console.log(res);
    })  
...
class HomePage extends React.Component {
    ...
    postSearch() {
      if((this.state.recentSearches.map(e => {return e.symbol}))
    ...
    render () {
        ...
        <div>
          ...
          <br/>
          <Table  dataSource={this.state.recentSearches} 
                  columns={tableFormat} />
          <Button type="primary"
                  style={divStyleRight} 
